  ...
  function loadDonateSection() {
    content.innerHTML = `
      <section class="donate-section">
        <h2>Support GAPSA</h2>
        <p>Thank you for considering a donation to the Global Alliance for Peace and Solidarity Africa (GAPSA). Your support helps us continue our mission and make a difference in refugee communities.</p>
